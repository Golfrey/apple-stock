...
- Receive Slack alerts for newly available pickup dates, without repeated messages for unchanged stock.
...
Alerts track product/store pairs and pickup dates. Failed API requests remain unknown instead of becoming “out of stock.” Failed Slack deliveries are retried. Requests are paced, overlapping checks are locked out, and errors trigger backoff.
